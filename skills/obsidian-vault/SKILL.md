...
1. **Файловый бэкап машины.** Если у машины есть файловый бэкап (restic, borg, Time Machine), в нём лежит и `.claude/`, и `.obsidian/`, и незакоммиченное. Конкретная схема — в vault-скилле этого vault. Восстанавливай **в отдельный каталог** и сравнивай, а не поверх рабочего дерева — часть свежих изменений может быть легитимной.
