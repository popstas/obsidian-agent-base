...
**Не используй** относительные markdown-ссылки (`[text](../folder/file.md)`) — они хрупкие. Для нот вольта — только `[[wikilinks]]` или абсолютные http-ссылки; для скиллов — код-спан по имени, см. исключение выше.
