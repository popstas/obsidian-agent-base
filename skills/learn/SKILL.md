...
1. Определи, к какому скиллу относится урок. Кандидаты ищи в `skills/<name>/SKILL.md` (проектные — этот вольт скиллы держит в `skills/`, не в `.claude/skills`, см. `obsidian-vault`) и в `~/.claude/skills/` (глобальные).
