...
2. Покажи пользователю список целиком, пометив те, чей хэш разошёлся, и спроси **один раз на всю группу**: «Удалить инструкции по развёртыванию? Они больше не нужны, но в `INTEGRATION.md` лежит единственное описание обновлений через `base-sync` и установки на второй машине».
